          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-white dark:bg-[#101512] border border-[#BFE5D3] dark:border-[#26302A] rounded-lg font-bold text-[#12372A] dark:text-[#F9FAFB]"
              />
            </div>

            <div>
              <label className="text-[10px] font-bold text-slate-600 dark:text-slate-400 block">Work Hours / Week:</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-[10px] font-bold text-slate-600 dark:text-slate-400 block">Filing Status:</label>
              <select
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-black text-[#1F8F68] dark:text-[#22C55E]">
                  {isContractor ? (
                    <AnimatedCounter
