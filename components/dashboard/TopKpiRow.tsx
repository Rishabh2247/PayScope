    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-stretch">
      ...
      <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-sm space-y-2 flex flex-col justify-between">
        ...
        <div className="inline-block bg-purple-50 text-purple-700 text-[10px] font-bold px-2 py-0.5 rounded-full w-fit">
          Based on {tax.annualBillableHours.toLocaleString()} hrs/yr
        </div>
      </div>

      {/* CARD 4: Download Report Card */}
      <div
      ...
      >
        <div className="space-y-1">
          ...
          <p className="text-sm font-bold text-indigo-950">Download Report</p>
          <p className="text-xs text-indigo-600/80 font-medium">Detailed breakdown</p>
        </div>
